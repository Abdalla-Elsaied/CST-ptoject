...
export const JF_USERS          = 'JF_users';
export const JF_PRODUCTS       = 'JF_products';
export const JF_ORDERS         = 'JF_orders';
export const JF_CURRENT_USER   = 'JF_currentUser';
export const JF_CART           = 'JF_cart';
export const JF_SEEDED         = 'JF_seeded';
